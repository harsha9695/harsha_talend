...
package harsha_talend.harsha_first_0_1;
...
/**
 * Job: harsha_first Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class harsha_first implements TalendJob {
	...
	private final String jobName = "harsha_first";
	private final String projectName = "HARSHA_TALEND";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(harsha_first.this, new Object[] { e,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/gogada.vardhan/Desktop/test.txt";
					...
					while (fid_tFileInputDelimited_1 != null
						...
						if (row1 != null) {
							...
							if (row1.Column0 != null) { //
								row_tLogRow_1[0] = String.valueOf(row1.Column0);

							} //

							if (row1.Column1 != null) { //
								row_tLogRow_1[1] = String.valueOf(row1.Column1);
	...
	public void tFileInputDelimited_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_2.addRow(new String[] { "Column0", "Column1", });
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Users/gogada.vardhan/Desktop/test.txt";
					...
					while (fid_tFileInputDelimited_2 != null
						...
						try {
							...
							row2.Column0 = fid_tFileInputDelimited_2
						...
						if (row2 != null) {
							...
							if (row2.Column0 != null) { //
								row_tLogRow_2[0] = String.valueOf(row2.Column0);

							} //

							if (row2.Column1 != null) { //
								row_tLogRow_2[1] = String.valueOf(row2.Column1);
	...
	public void tFileInputDelimited_3Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_3.addRow(new String[] { "Column0", "Column1", });
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "C:/Users/gogada.vardhan/Desktop/test.txt";
					...
					while (fid_tFileInputDelimited_3 != null
						...
						try {
							...
							row3.Column0 = fid_tFileInputDelimited_3
						...
						if (row3 != null) {
							...
							if (row3.Column0 != null) { //
								row_tLogRow_3[0] = String.valueOf(row3.Column0);

							} //

							if (row3.Column1 != null) { //
								row_tLogRow_3[1] = String.valueOf(row3.Column1);
	...
	public static void main(String[] args) {
		final harsha_first harsha_firstClass = new harsha_first();

		int exitCode = harsha_firstClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = harsha_first.class.getClassLoader()
					.getResourceAsStream(
							"harsha_talend/harsha_first_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = harsha_first.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : harsha_first");
		}
